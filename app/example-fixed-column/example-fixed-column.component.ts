...
@Component({
  selector: 'app-example-fixed-column',
  templateUrl: './example-fixed-column.component.html',
  styleUrls: ['./example-fixed-column.component.css']
})
export class ExampleFixedColumnComponent implements OnInit {
  displayedColumns =
